    ...
    <footer className="footer">
      <div className="footer__top container">
        ...
        <div className="footer__brand">
          ...
          <div className="footer__socials">
            <a href={WA_URL} target="_blank" rel="noopener noreferrer" className="footer__social footer__social--wa">
              <WAIcon />
            </a>
            <a href={INSTAGRAM} target="_blank" rel="noopener noreferrer" className="footer__social">
              <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href={FACEBOOK} target="_blank" rel="noopener noreferrer" className="footer__social">
              <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="footer__col">
          ...
          <p className="footer__col-title" style={{ marginTop: '20px' }}>Crédito</p>
      ...
      <div className="footer__bottom">
        <div className="container footer__bottom-inner">
          <p>© {year} Nuovocell · Valencia, Venezuela · {t('footer.rights')}</p>
          <p>
            <a href={WA_URL} target="_blank" rel="noopener noreferrer">+58 412-362-1133</a>
          </p>
        </div>
      </div>
